...
//		IO::save01_in_u8(meanImage, TEMPO_PATH+"average.png");
...
//	IO::save01_in_u8(cycleEvaluationMap, std::string(TEMPO_PATH+"cycleEvaluationMap129_") + textureName + ".png");
...
//	}
	...
	IO::save01_in_u8(im_in, TEMPO_PATH+"input.png");
